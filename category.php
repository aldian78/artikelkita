...
$id = abs((int)$_GET['id']);
$get_cat = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM tw_category WHERE cat_id='$id'"));
...
echo '<div class="content-title" style="background:#000; color:#FFF; border:1px solid #000;">- Kategori &raquo; '.$get_cat['cat_name'].' -</div>';
