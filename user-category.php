...
<div class="content-title" style="background:#000; color:#FFF; border:1px solid #000;">- Kelola Kategori -</div>
<div class="content-body">
	...
	if($_GET['aksi'] == "edit"){
		...
		if($_POST['simpan-kategori']){
			...
			if($kat){
				$up = mysqli_query($koneksi, "UPDATE tw_category SET cat_name='$kat' WHERE cat_id='$id'");
				if($up){
