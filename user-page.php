...
<div class="content-title" style="background:#000; color:#FFF; border:1px solid #000;">- Kelola Halaman/Page -</div>
<div class="content-body">
	...
	if($_GET['aksi'] == "delete"){
		...
		if(mysqli_num_rows($cek) != 0){
			$del = mysqli_query($koneksi, "DELETE FROM tw_page WHERE page_id='$id'");
			if($del){
